...
settings_types = {
    "action": {settings_type.name: settings_type for settings_type in action_types},
    "validation": {settings_type.name: settings_type for settings_type in validation_types}
}
